...
import { Layers, CheckSquare, Briefcase, DollarSign, Cpu, Zap, Heart, Wrench, Hash, Palette } from 'lucide-react';
...
const ALL_SKILLS_DATA: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { label: 'Cultural Awareness/Sensitivity', id: 'interpersonal_cultural_awareness' },
  ...
  },
  {
    ...
    icon: Layers,
    skills: [
      { label: 'Communicate in Plain Language', id: 'communication_plain_language' },
      { label: 'Conflict Resolution', id: 'communication_conflict_resolution' },
      { label: 'Facilitation and Training', id: 'communication_facilitation_training' },
      { label: 'Interpersonal Communication', id: 'communication_interpersonal' },
      { label: 'Public and Media Relations', id: 'communication_media_relations' },
      { label: 'Public Speaking/Presentation Skills', id: 'communication_public_speaking' },
  ...
  },
  {
    ...
    skills: [
      ...
      { label: 'Community Knowledge/Awareness', id: 'organizational_community_knowledge' },
      { label: 'Manage Meetings & Groups', id: 'organizational_manage_meetings' },
  ...
  },
  {
    ...
    skills: [
      ...
      { label: 'Decision-Making/Prioritizing', id: 'leadership_decision_making' },
      ...
      { label: 'Thought Leadership (Innovation)', id: 'leadership_thought_leadership' },
    ],
  },
  {
...
const SkillCheckbox: React.FC<CheckboxProps> = ({ skill, checked, onToggle }) => (
  <label
...
const SkillsPositions = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (selectedSkills.size === 0) {
      setSubmissionMessage('Please select at least one skill before searching.');
    } else {
      ...
      setSubmissionMessage(
        `Searching for positions requiring ${selectedSkills.size} skills: ${selectedLabels.join(', ')}`
      );
    }
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-gray-200">
              <div>
                {submissionMessage && (
                  <p className={`text-sm ${selectedSkills.size === 0 ? 'text-red-500' : 'text-green-600'}`}>
                    {submissionMessage}
                  </p>
                )}
              </div>
