      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-xl overflow-hidden transform transition-all duration-300 hover:shadow-2xl animate-fade-in-up">
          ...
          <div className="p-8">
            ...
            >
              The Night West Shore Showed Its Heart: With Gratitude and Applause
              to Our 2025 Gala Supporters.
            </h1>

            {/* Meta Information */}
            <div
              className="flex flex-wrap items-center gap-4 text-sm mb-6 scroll-reveal scroll-reveal-delay-2"
            ...
            >
              It was more than an event. It was a defining moment—where purpose,
              creativity, and community gathered under one roof to celebrate
              something far bigger than a single evening.
            </p>
            ...
            <p
              ...
              style={{ color: "#061839" }}
            >
              The 2025 West Shore Arts Gala will go down in memory not only as a
              fundraiser, but also as a shared declaration: the arts matter
              here, and the West Shore is ready to champion them like never
              before.
            </p>
            ...
            >
              Hosted against the elegant backdrop of Olympic View Golf Club, the
              night carried an undeniable energy. From the warmth of the
              welcoming reception to the final standing applause, every end of
              the venue reflected connection, generosity, and belonging.
              Surrounded by scenic panoramic views, thoughtful hospitality, and
              a vibrant room of changemakers, the environment became the perfect
              stage for a movement in the making.
            </p>
          ...
          >
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-start gap-2 stagger-item">
                ...
                <span style={{ color: "#061839" }}>What's next for the</span>
              </li>
            </ul>
          </div>
        </div>
