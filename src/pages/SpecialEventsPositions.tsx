...
const mockPositions: EventPosition[] = [
  {
    id: 1,
    position: "Environmental Volunteer",
    program: "Meet New Friends & Remove Invasive Species",
    organization: "Greater Victoria Green Team",
    endDate: "2025-12-06",
    location: "Dickson Woods, North Saanich",
  },
  {
    id: 2,
    position: "Celebration of Lights Volunteer",
    program: "Celebration of Lights Esquimalt",
    organization: "Victoria Rainbow Kitchen Society",
    endDate: "2025-12-07",
  },
  {
    id: 3,
    position: "Environmental Volunteer",
    program: "Meet Community & Remove Invasive Plants from UVic",
    organization: "Greater Victoria Green Team",
    endDate: "2025-12-07",
    location: "UVic - Dec 7",
  },
  {
    id: 4,
    position: "Winter Dinner",
    program: "2025 Winter Dinner",
    organization: "Quadra Village Community Centre",
    endDate: "2025-12-11",
  },
  {
    id: 5,
    position: "Breakfast with Santa! Various Roles",
    program: "2025 Breakfast with Santa 12-13 Dec",
    organization: "Victoria West Community Association",
    endDate: "2025-12-13",
  },
  {
    id: 6,
    position: "Environmental Volunteer - Dickson Woods Dec 13",
    program: "Remove Invasive Plants at Dickson Woods",
    organization: "Greater Victoria Green Team",
    endDate: "2025-12-13",
    location: "Dickson Woods Dec 13",
  },
  {
    id: 7,
    position: "Ice Crew",
    program: "BC Men's and Women's and U20 Curling Championships",
    organization: "Curl BC",
    endDate: "2026-01-04",
  },
  {
    id: 8,
    position: "Volunteer Ambassadors",
    program: "17th Annual Gingerbread Showcase",
    organization: "Habitat for Humanity Victoria",
    endDate: "2026-01-04",
  },
  {
    id: 9,
    position: "2026 Victoria Film Festival Driver Volunteers",
    program: "2026 Victoria Film Festival (Feb 6–15)",
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="text-center text-gray-500 text-sm p-4 bg-white rounded-xl shadow-md">
              Displaying {filteredPositions.length} of {positions.length}{" "}
              entries.
