...
const LOCATION_OPTIONS: string[] = [
  'Any Location', 'Victoria', 'Oak Bay', 'Esquimalt', 'Saanich', 'View Royal',
  'Colwood', 'Langford', 'Metchosin', 'Sooke', 'Highlands',
  'Central Saanich', 'North Saanich', 'Sidney', 'Everywhere', 'Remote/Virtual',
];
  ...
  const handleLocationChange = (location: string) => {
    setFormData(prev => {
      ...
      if (location === 'Any Location' || location === 'Everywhere') {
        ...
        if (isChecked) {
             Object.keys(newLocations).forEach(key => (newLocations[key] = false));
    ...
    <div className="py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <h1 className="text-3xl font-bold mb-6 text-[#061839]">Search Volunteer Opportunities</h1>
          <p className="text-lg mb-8 text-[#061839] opacity-80">
            To help you find a suitable volunteer opportunity, please answer all the following questions.
          </p>

          <form onSubmit={handleSubmit}>
            {/* Keyword Search */}
            <div className="mb-8">
              <label htmlFor="keyword" className="block font-semibold mb-2 text-[#061839] text-lg">
                Keyword Search
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-wrap items-start justify-between mb-8 gap-6">
              <div className="flex-1 min-w-[200px]">
                <label htmlFor="volunteerType" className="block font-semibold mb-2 text-[#061839] text-lg">
                  I will volunteer as:
                </label>
              ...
              <div className="flex space-x-6">
                <div className="flex-shrink-0">
                  <label htmlFor="gender" className="block font-semibold mb-2 text-[#061839] text-lg">
                    Gender:
                  </label>
                  <div className="flex items-center">
                    <select
                ...
                <div className="flex-shrink-0">
                  <label htmlFor="age" className="block font-semibold mb-2 text-[#061839] text-lg">
                    My Age:
                  </label>
                  <div className="flex items-center">
                    <select
            ...
            <div className="mb-8">
              <label htmlFor="volunteerFor" className="block font-semibold mb-2 text-[#061839] text-lg">
                I will volunteer for:
              </label>
              <select
                id="volunteerFor"
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-3">
                {LOCATION_OPTIONS.map((location) => (
                  <label key={location} className="flex items-center space-x-3 cursor-pointer p-3 rounded-lg hover:bg-gray-50 transition-colors">
                    <input
                      type="checkbox"
                      name="locations"
